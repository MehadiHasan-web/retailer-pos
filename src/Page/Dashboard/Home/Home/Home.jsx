                ...
                <TabPanel className="mt-5">
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    ...
                    {products.map(product => (
                      <div className=" bg-base-100 shadow-xl p-3 rounded-md" key={product.id}>
                          ...
                          <div className="w-[65%]">
                            ...
                            <ul className='flex items-center gap-32 mt-2'>
                              <li>
                                ...
                                <p className='text-base font-bold'>{product.net_weight}</p>
                              </li>
                              <li>
                                <p className='text-sm'>Stock</p>
                                <p className='text-base font-bold'>{product.stock} Available</p>
                              </li>
                            </ul>
                          </div>
                        </div>
                        <div className='flex justify-between items-center mt-2'>
                          <div className='w-[35%] flex items-center justify-center'>
                            <sup className='text-green-600 font-bold'>$</sup><p className='text-center'><span className='text-2xl font-bold'>{product.price}</span><span className='text-gray-500'>/Bottle</span></p>
                          </div>
                          <div className="w-[65%] ">
                            <ul className='flex justify-between items-center bg-slate-200 py-1 px-3 rounded-2xl'>
                              <li>
                                <button onClick={() => decreaseQuantity(product.id)}><FaCircleMinus className='text-white text-xl'></FaCircleMinus></button>
                              </li>
                              <li>{product.quantity}</li>
                              <li>
                                <button onClick={() => updateQuantity(product.id)} className='m-0 p-0'><FaCirclePlus className='text-green-600 text-xl'></FaCirclePlus></button>
                              </li>
                            </ul>
                            <button>Add</button>
                          </div>
